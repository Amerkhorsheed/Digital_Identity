...
/// سجلّ مطابقة بصمة واحدة ناجحة، مرفق ببطاقة المنتسب.
///
/// السجل يوثّق **كيف** تحقّقت الشخصية لا مجرد أنها تحقّقت: الوسيلة المستخدمة،
...
class BiometricCapture {
  ...
  ///
  /// في مسار العتاد: ليست قالب بصمة ولا مشتقة من بيانات بصمة — نظام
